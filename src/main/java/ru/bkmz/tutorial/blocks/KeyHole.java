...
public class KeyHole extends Block {
    ...
    public KeyHole() {
        ...
        setUnlocalizedName(ModMain.MODID + ".keyhole");
        setHardness(.5F);
        setHarvestLevel("pickaxe", 2);
        setCreativeTab(ModMain.creativeTabsAllmod);
    ...
    public void initItemModel() {
        Item itemBlock = Item.REGISTRY.getObject(new ResourceLocation(ModMain.MODID, "keyhole"));
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, EnumFacing.getHorizontal(meta & 7)).withProperty(IS_OPENED, (meta & 8) > 0);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (playerIn.getHeldItem(hand).getItem() == AllItems.key) {
